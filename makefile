...
client: client.o crypto.o networking.o commands.o nv_packet.o nv_response.o b58check.o pack.o
	$(CXX) $(CXXFLAGS) -o client client.o crypto.o networking.o commands.o nv_packet.o nv_response.o b58check.o pack.o $(LIBS)

client.o: client.cpp common_constants.h crypto.h networking.h commands.h nv_packet.h nv_response.h
	$(CXX) $(CXXFLAGS) -c client.cpp $(INCDIR)

server: server.o database.o crypto.o networking.o btc.o commands.o nv_packet.o nv_response.o b58check.o pack.o
	$(CXX) $(CXXFLAGS) -o server server.o database.o crypto.o networking.o btc.o commands.o nv_packet.o nv_response.o b58check.o pack.o $(LIBS)

server.o: server.cpp common_constants.h database.h crypto.h networking.h btc.h commands.h nv_packet.h nv_response.h
